...
var index$1 = require("../../dist/index-c72d1a7e.cjs.prod.js");
...
var reactTransitionGroup = require("react-transition-group"), AnimatedInput = function(WrappedComponent) {
  ...
  function Collapse() {
    ...
    return (_this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Collapse)).call.apply(_getPrototypeOf2, [ this ].concat(args)))).duration = collapseDuration, 
